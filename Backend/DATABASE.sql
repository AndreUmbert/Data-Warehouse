...
CREATE TABLE IF NOT EXISTS `data_warehouse`.`company` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_company_city1_idx` (`cityId` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `data_warehouse`.`channelhascontact`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `data_warehouse`.`channelhascontact` (
  `channelId` INT(11) NOT NULL,
  `contactId` INT(11) NOT NULL,
  PRIMARY KEY (`channelId`, `contactId`),
  INDEX `fk_channel_has_contact_contact1_idx` (`contactId` ASC) VISIBLE,
  INDEX `fk_channel_has_contact_channel1_idx` (`channelId` ASC) VISIBLE,
  CONSTRAINT `fk_channel_has_contact_channel1`
    FOREIGN KEY (`channelId`)
    REFERENCES `data_warehouse`.`channel` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_channel_has_contact_contact1`
